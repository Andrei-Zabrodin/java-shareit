...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> patchItem(ItemDto requestDto, long userId, long itemId) {
        return patch("/" + itemId, userId, requestDto);
    }

    public ResponseEntity<Object> postComment(CommentDto requestDto, long userId, long itemId) {
